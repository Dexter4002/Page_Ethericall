...
<html lang="pl">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="card" style="width: 18rem; margin-left: 60px; margin-top: 90px;">
  <div class="card-body">
...
<?php
	...
	if (isset($_POST['email']))
	{
		...
		{
			$wszystko_OK=false;
			$_SESSION['e_nick']="Nick może skladac sie tylko z liter i cyfr (bez polskich znakóww)";
		}
		...
		try 
		{
			...
			else
			{
				...
				//Czy nick jest ju� zarezerwowany?
